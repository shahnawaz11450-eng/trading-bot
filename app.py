...
def api_status():
    ...
    try:
        ...
        return jsonify({
            ...
            'system_health_total': data.get('system_health_total', 0),
            'trading_quality_score': data.get('trading_quality_score', 0),
            'trading_quality_total': data.get('trading_quality_total', 0),
            'verdict': data.get('verdict', ''),
            'win_rate': data.get('win_rate_pct', 0),
            'hac_sr_execsim': data.get('hac_sr_execsim', 0),
            'long_count': data.get('long_count', 0),
            'short_count': data.get('short_count', 0),
            'total_pnl_pct': data.get('total_pnl_pct', 0),
            'long_pnl_pct': data.get('long_pnl_pct', 0),
            'short_pnl_pct': data.get('short_pnl_pct', 0),
